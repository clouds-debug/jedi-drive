...
const steps = [
  { n: 1, title: "Заявка", desc: "Пишешь нам, что нужно: только теория, только практика или оба блока." },
  { n: 2, title: "Формат", desc: "Подбираем темп — группа онлайн, индивидуально, удобные дни и время." },
  { n: 3, title: "Учим", desc: "Теория идёт по Zoom, практика — на площадке и в реальном городе." },
  { n: 4, title: "На экзамен", desc: "Доводим до уверенной сдачи: маршруты, билеты, разбор слабых мест." },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 relative">
        <Reveal>
          ...
          <h2 className="text-[28px] sm:text-[34px] font-medium text-white tracking-[-0.015em] mb-3 max-w-[540px]">
            Теория и практика — <span className="text-orange">независимо</span>
          </h2>
          <p className="text-[14px] text-muted-on-navy leading-[1.65] mb-12 max-w-[540px]">
            Можно прийти только за теорией, только за практикой или брать оба блока — программа собирается под тебя.
          </p>
        </Reveal>
          ...
          {steps.map((step, i) => (
            <Reveal key={step.n} delay={i * 100}>
              <div className="relative">
                ...
                <div className="text-[15px] font-medium text-white mb-1">{step.title}</div>
                <div className="text-[12.5px] text-muted-on-navy leading-[1.6]">{step.desc}</div>
              </div>
            </Reveal>
          ))}
        </div>

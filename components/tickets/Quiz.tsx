...
export function Quiz({ questions, mode, topic }: QuizProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <article
        key={current.id}
        className="relative bg-white/[0.04] border border-white/15 border-l-[3px] border-l-orange rounded-2xl p-6 sm:p-8 lg:p-10 overflow-hidden animate-card-in"
      >
        ...
        {current.image && (
          <div className="relative mb-5 lg:mb-6 rounded-xl overflow-hidden border border-white/10 bg-[#0F1430]">
        ...
        <h2 className="relative text-[18px] sm:text-[20px] lg:text-[23px] font-medium text-white leading-snug mb-6 lg:mb-7">
        ...
        <div className="relative space-y-2.5 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-4">
          {current.options.map((opt, i) => {
            ...
            let cls =
              "relative w-full text-left bg-white/[0.03] border border-white/10 rounded-lg px-4 py-3.5 lg:px-5 lg:py-4 text-[14px] lg:text-[15.5px] text-white transition-all";

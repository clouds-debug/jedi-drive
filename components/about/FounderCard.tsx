            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-8 p-6 sm:p-8 lg:p-10">
              ...
              <div>
                ...
                <div className="space-y-4 text-[14.5px] text-white/95 leading-[1.7] mb-7">
                  <p>
                    Сам сел за руль в 18, прошёл путь от полной растерянности до уверенного водителя за 8 месяцев. После этого ещё 3 года работал инструктором в другой школе — и понял, что хорошие наставники в Тбилиси встречаются реже, чем должны.
                  </p>
                  <p>
                    В 2023 году собрал свою команду — инструкторов, которые разделяют главное правило: терпение важнее результата. Lояльность к ученику, ясность объяснений, никакого давления.
                  </p>
                </div>

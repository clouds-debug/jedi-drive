...
const STRINGS: Dict = {
  ...
  "remind.body": {
    ...
    ge: "{{title}}\n\nშენ გაქვს <b>პრაქტიკა</b>\n📅 {{date}}\n🚗 {{instructor}} · {{format}}\n\nდაადასტურე, რომ მოხვალ.",
  },
  "remind.btn.coming": { ru: "✅ Приду", ge: "✅ მოვალ" },
  "remind.btn.notComing": { ru: "❌ Не приду", ge: "❌ ვერ მოვალ" },
  "remind.ack.coming": { ru: "Отлично, ждём тебя! 🚗", ge: "შესანიშნავია, გელოდებით! 🚗" },
  "remind.ack.notComing": {
    ru: "Жаль. Скоро с тобой свяжется модератор.",
  ...
  "att.btn.cancel": { ru: "Отменить занятие", ge: "გაკვეთილის გაუქმება" },
  "att.cb.handled": { ru: "Помечено как обработано", ge: "მოინიშნა როგორც დამუშავებული" },
